...
export async function getPeriodMasters(
  req: Request,
  res: Response,
  next: NextFunction
): Promise<void> {
  try {
    ...
    const entries = await PeriodMasterService.getPeriodMastersBySession(req.db, sessionId)
...
export async function setPeriodMasters(
  req: Request,
  res: Response,
  next: NextFunction
): Promise<void> {
  try {
    ...
    const entries = await PeriodMasterService.setPeriodMasters(req.db, parsed.data)
